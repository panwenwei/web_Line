    ...
    <div class="grid grid-cols-24 gap-4 mt-4">
      <div class="col-span-9 shadow inline-block">
          ...
          <table class=" min-w-full divide-y divide-gray-200">
              <thead class="table-fixed bg-gray-50 " >
                <tr>
                  <th
                    scope="col"
              ...
              <tbody class="bg-white divide-y divide-gray-200 overflow-auto h-200">
                {people.map((person,key) => (
                  <tr key={person.email} class={key%2==1?'bg-gray-100':''} className="table-fixed">
